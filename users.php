    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row" id="js-contacts">
                ...
                ?>
                    <div class="col-xl-4">
                        <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?=strtolower($user['fullname'])?>">
                            <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                                ...
                                <span class="<?=$status?> mr-3">
                                    ...
                                    <div class="info-card-text flex-1">
                                        <a href="page_profile.php?id=<?=$user['id']?>" class="fs-xl text-truncate text-truncate-lg text-info"><?=$user['fullname']?></a>
                                        <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                            <?php if(is_admin() || is_author($_SESSION['user']['id'], $user['id'])):?>
                            ...
                            <div class="card-body p-0 collapse show">
                                <div class="p-3">
                                    ...
                                    <div class="d-flex flex-row">
                                        ...
                                        <a href="https://t.me/<?=$user['tg']?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                            <i class="fab fa-telegram"></i>
                                        </a>
                                        <a href="https://instagram.com/<?=$user['insta']?>" class="mr-2 fs-xxl" style="color:#E1306C">
